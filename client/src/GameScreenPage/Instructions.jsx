...
class Instructions extends Component {
  ...
  handleHover (helpContent, helpPosition) {
    ...
    this.setState({
      tooltipClassName : 'tooltip-eridani',
      tooltipStyle,
  ...
  render () {
    ...
    return (
      <div className="instructions-container">
        ...
        <div id='tooltip-eridani' className={tooltipClassName} style={tooltipStyle} dangerouslySetInnerHTML={{__html:tooltipContent}} ref={this.setTooltipRef}></div>
      </div>
    )
  }
}
