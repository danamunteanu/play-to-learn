...
import { warningReset, wrongAnswerWarning, completeAllLevelsWarning } from '../_constants/levels.js'
import { setAnswers, resetAnswers } from '../_actions'
import { setLevel } from '../_actions/level'
import { setSolved, resetSolved } from '../_actions/solved'
import LevelCounter from '../GameScreenPage/LevelCounter.jsx'
import Intructions from '../GameScreenPage/Instructions.jsx'
import CodeEditor from '../GameScreenPage/CodeEditor.jsx'
import DemoArea from '../GameScreenPage/DemoArea.jsx'
import Guardian from '../GameScreenPage/Guardian.jsx'
import { airLevels } from '../_constants/levels.js'

class GameScreenPage extends Component {
  constructor (props) {
    super(props)
  ...
  saveAnswer () {
    ...
    console.log('set Answers',this.props.setAnswers)
  ...
  render () {
    ...
    return (
      <div className='container full-width game-container'>
...
const connectedGameScreenPage = connect(mapStateToProps,mapDispatchToProps)(GameScreenPage);
export { connectedGameScreenPage as GameScreenPage };

GameScreenPage.propTypes = {
